    ...
    public List<CartDTO> getCart(UserIdRequest userIdRequest) {
        ...
        for (CartModel cart : carts) {
            ...
            if (discounts != null) {
                ...
                productFinal = new ProductDTO(product.getId(), product.getName(), owner, (int) productOgPrice, true, product.getPriceInCents(), product.isShowing(), product.isAvailable(), product.getStock(), product.getDescription());
            } else {
                productFinal = new ProductDTO(product.getId(), product.getName(), owner, product.getPriceInCents(), false, product.getPriceInCents(),product.isShowing(),product.isAvailable(), product.getStock(), product.getDescription());
            }
